...
var quickpollexpirationdate = parseInt("<?php echo $expirationtime; ?>");
...
function timer()
{
    ...
    // if we reach the expirationtime; display "Time has passed!"
    if(dif <= 0){
		    
	    message += "<span id=\"countdown\"><b>The time has passed! Your answers will nog longer be submitted</b></span>";
